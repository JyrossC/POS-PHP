		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>Product List</b>
						<span class="float:right"><a class="btn btn-success btn-block btn-sm col-sm-2 float-right" href="index.php?page=add-product" id="new_order">
						...
						<table class="table table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
									<?php echo number_format($row['buying_price'],2) ?></td>
									</td>
									<td class="">
									<?php echo number_format($row['price'],2) ?></td>
									</td>
									<td class="">
									<?php echo number_format($row['quantity'],2) ?></td>
									</td>
									<td class="">
