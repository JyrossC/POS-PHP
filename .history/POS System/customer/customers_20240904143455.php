    ...
    <div class="card mt-4 transparent">
        <div class="card-header">
            <small class="mb-0">Customer List
                <a href="add-customer.php" class="btn btn-success float-end"><span style="font-size: 1.7em;">+</span> Add Customers</a>
            </small>
        </div>
        <div class="card-body">
            <?php alertMessage(); ?>
                        ...
                        <tr>
                            ...
                            <td class="justify-content-center">
                                <?php
                                   if($item['status'] == 1 )
                                   {
                                    echo '<span class="badge bg-danger text-dark">Hidden</span>';
                                   }
                                   else
                                   {
                                    echo '<span class="badge bg-success text-dark">Visible</span>';
                                   }
                                ?>
