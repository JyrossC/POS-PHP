                      ...
                      <!--    <b>Category</b> -->
                        <div class=" row justify-content-start align-items-center" id="cat-list">
                            <div class="mx-3 cat-item" data-id = 'all'>
                                <button class="btn btn-warning"><b class="text-white">All</b></button>
                            </div>
                            <?php
                            ...
                            <div class="mx-3 cat-item"  data-id = '<?php echo $row['id'] ?>'>
                                <button class="btn btn-success"><?php echo ucwords($row['name']) ?></button>
                            </div>
                            <?php endwhile; ?>
                        </div>
            ...
            <form action="" id="manage-order">
                ...
                <div class="bg-white" id='o-list'>
                   ...
                   <table class="table bg-light mb-5 text-center" >
                       ...
                       <thead>
                           <tr>
                               <th>Quantity <small>(Meters)</small></th>
                               <th>Product Name<br><small> (price)</small></th>
                               <th>Amount <br> <small>(Tsh)</small></th>
                               <th>Action <br><small>(Delete)</small></th>
                           </tr>
                       </thead>
                       <tbody>
                           <?php
                   ...
                   <div class="d-block bg-white" id="calc">
                       <table class="" width="100%">
                           <tbody>
                                <tr>
                                   <td class="text-danger"><b><h6>Total Due</h6></b></td>
                                   <td class="text-right">
...
<div class="modal fade" id="pay_modal" role='dialog'>
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" id="save_order">Postpone</button>
      </div>
      </div>
    </div>
  </div>
