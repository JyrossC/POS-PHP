	...
	<div class="row mt-3 ml-3 mr-3">
        ...
        <div class="col-lg-8  p-field">
            <div class="card ">
                ...
                <!-- <div class="container card-header text-dark" style="" >
                    <label for="">Customer Name</label>
                    <input class="form-control form-control-sm" type="text" name="customer" placeholder="Customer Name" aria-label=".form-control-sm example">
                </div><div class="container card-header text-dark" style="" >
                    <label for="">Customer Phone</label>
                    <input class="form-control form-control-sm" type="number" name="phone" placeholder="Customer Phone" aria-label=".form-control-sm example">
                </div> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-2">
                                <div class="prod-item text-center " data-json = '<?php echo json_encode($row) ?>' data-category-id="<?php echo $row['category_id'] ?>">
                                    <img src="../assets/uploads/" class="rounded" width="100%">
                                        <span>
            ...
            <div class="card-footer">
                <div class="row justify-content-center">
                    ...
                    <div class="btn btn btn-sm col-sm-3 btn-warning" type="button" id="save_order">Pay later</div>
                </div>
            </div>
            </div>
        </div>
        ...
        <!-- Cart Form  Starts Here-->
          <div class="col-lg-4">
           <div class="card">
                <div class="card-header text-dark">
                    <b>Order Slip</b>
                <span class="float:right"><a class="btn btn-info btn-sm col-sm-3 float-right" href="../index.php" id="">
            ...
            <form action="" id="manage-order">
                ...
                <label for="" class="text-dark"><b><h6>Customer Name</h6> </b></label><br>
                    <div class="d-flex w-100 bg-white mb-1">
                        <input type="text" class="form-control-sm" name="customer_name" value="<?php echo isset($customer_name) ? $customer_name : '' ?>" required>
                    </div>
                       ...
                       <tbody>
                           ...
                           <tr>
                               ...
                               <td>
                                ...
                                <td>
                                    <input type="text" name="item_id[]" id="" value="<?php echo $row['id'] ?>">
                                    <input type="text" name="product_id[]" id="" value="<?php echo $row['product_id'] ?>"><?php echo ucwords($row['name']) ?>
                                    <small class="psmall"> (<?php echo number_format($row['price'],2) ?>)</small>
                                </td>
                                <td class="text-right">
                                    <input type="text" name="price[]" id="" value="<?php echo $row['price'] ?>">
                                    <input type="text" name="amount[]" id="" value="<?php echo $row['amount'] ?>">
                                ...
                                <tr>
                                   ...
                                   <td class="text-right">
                                    <?php $total = $row['price'] * $row['qty']  ?>
                                       ...
                                       <input type="text" name="total_tendered" value="0">
                                       <span class="text-danger"><h6><b id="total_amount"><?php echo $total ?></b></h6></span>
                                   </td>
                               </tr>
                           </tbody>
                       </table>
...
<div class="modal fade" id="pay_modal" role='dialog'>
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
      <div class="modal-content">
        ...
        <h5 class="modal-title"><b>Cash Payment</b></h5>
      ...
      <div class="modal-body">
        <div class="container-fluid">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control text-right text-danger" id="change" value="0.00" readonly="">
            </div>
        </div>
      </div>
      <div class="modal-footer">
        <button type="submit" class="btn btn-success btn-sm"  form="manage-order">Pay</button>
