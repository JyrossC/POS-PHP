            ...
            <div class="card ">
                ...
                <div class="card-body row" id='prod-list'>
                    <div class="col-md-12">
                         ...
                         <hr>
                        <div class=" row justify-content-start align-items-center" id="cus-list">
                            <?php
                            $qry = $conn->query("SELECT * FROM customers order by name asc");
                            while($row=$qry->fetch_assoc()):
                            ?>
                            <input type="text" name="customers" value="" placeholder="Select Customer">
                            <div class="prod-item text-center " data-json = '<?php echo json_encode($row) ?>' data-customer-id="<?php echo $row['id'] ?>"></div>
                            <?php endwhile; ?>
                        </div>
                            ...
                            <td class="">
                               ...
                               <td>
                                ...
                                <td class="text-right">
                                    ...
                                    <span class="amount"><?php echo $row['amount'],2 ?></span>
                                </td>
                                <td>
