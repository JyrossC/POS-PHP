            ...
            <div class="card ">
                ...
                <div class="card-body row" id='prod-list'>
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <?php
                            $cust = $conn->query("SELECT * FROM customers where status = 1 order by name asc");
                            while($row=$prod->fetch_assoc()):
                            ?>
                            <div class="col-md-2 mb-2">
                                <div class="prod-item text-center " data-json = '<?php echo json_encode($row) ?>' data-customer-id="<?php echo $row['id'] ?>">
