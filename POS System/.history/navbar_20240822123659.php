...
<nav id="sidebar" class='mx-lt-5 bg-white' >
		...
		<h6 class="text-disabled mt-5" style="margin-left: 50px;" >Shop Insights</h6>
			...
			<h6 class="text-disabled " style="margin-left: 50px;" >Shop Settting</h6>
			...
			<h6 class="text-disabled " style="margin-left: 50px;" >Author Contacts</h6>
