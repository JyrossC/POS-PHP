...
<h3 class="text-dark text-center mb-5 mt-5" style="font-family: 'century gothic','Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;" >
	<b>Login now to Manage your Shop</b>
</h3>
		...
		'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; border-radius: 50px" >
			<div class="card-body" style="width: 90%; margin-left: 5%; "  >
				...
				<form id="login-form" >
					...
					<div class="mb-3" style="margin-rright: -40%;">
