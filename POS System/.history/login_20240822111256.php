...
<script src="https://www.google.com/recaptcha/api.js" async defer></script>
	...
	{
		document.getElementById("mySubmitBtn")
	}
</script>
  			...
  			<div class="card col-md-3 ml-5">
  				<div class="card-body py-5 px-1">
  					...
  					<form id="login-form" >
						...
						<div class="mb-3">
							<div class="g-recaptcha" data-sitekey="6LeE1-4pAAAAAGMqgDgNadlikWXqpv-cwQncLc8c"></div>
						</div>
  						...
  						<div class="mb-3">
						  <button class="btn btn-primary" id="mySubmitBtn" >Login</button>
						</div>
  					</form>
  				</div>
  			</div>
