...
<nav class="navbar navbar-light fixed-top bg-white">
  <div class="container-fluid mt-2 mb-2">
      ...
      <div class="col-md-2 float-left text-dark">
       ...
       <h5 class="text-success" ><?php echo isset($_SESSION['system']['name']) ? $_SESSION['system']['name'] : '' ?></h5>
      </div>
        ...
        <div class=" dropdown mr-4">
            <a href="#" class="text-dissabled dropdown-toggle"  id="account_settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="margin-left: -5;" ><?php echo $_SESSION['login_name'] ?></a>
              <div class="dropdown-menu" aria-labelledby="account_settings">
                <a class="dropdown-item" href="javascript:void(0)" id="manage_my_account"><i class="fa fa-cog"></i> <p>Manage Account</p></a>
                <a class="dropdown-item" href="ajax.php?action=logout"><i class="fa fa-power-off"></i> <p>Logout</p></a>
              </div>
        </div>
      </div>
  </div>
