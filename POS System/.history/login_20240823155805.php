...
<body style="background-color: beige;" >
	<div class="row-6 form-check py-3" style="margin-left: 8%;" >
		<h4 style="font-family: 'century gothic','Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; margin-left: 40%;" ></h4>>We are here to help you grow your business</h4>
	</div>
 ...
 Geneva, Verdana, sans-serif; margin-left: 40%;" >
