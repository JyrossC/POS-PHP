  ...
  <div class="container-fluid mt-2 mb-2">
      ...
      <div id="google_translate_element"></div>
        ...
        <div class=" dropdown mr-4">
            <h5 href="#" class="text-dissabled dropdown-toggle"  id="account_settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $_SESSION['login_name'] ?> </h5>
