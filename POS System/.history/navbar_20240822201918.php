...
<nav id="sidebar" class='mx-lt-5 bg-white w-10' >
		...
		<h6 class="text-disabled mt-5 text-success" style="margin-left: 50px;" >Shop Insights</h6>
			...
			<a href="customers.php?page=customers" class="nav-item nav-orders"><span class='icon-field'><i class="fa fa-clipboard-list mr-3"></i></span>Manage Customers</a>
			...
			<h6 class="text-disabled text-success" style="margin-left: 50px;" >Author Contacts</h6>
				...
				<a href="" target="_blank" class="nav-item nav-visit_website"><span class='icon-field'><i class="fa fa-chat mr-3"></i></span>Whatsapp</a>
		</div>
