        ...
        <div class="col-lg-8  p-field">
            <div class="card ">
                ...
                <div class="container card-header text-dark" id='prod-list' style="" >
                    ...
                    <input class="form-control form-control-sm" type="text" name="customer" value="<?php echo ucwords($row['name']) ?>" aria-label=".form-control-sm example">
                </div>
...
<script>
    cat.find("[name='customers']").val($(this).attr('data-name'))
    cat.find("[name='customers']").val($(this).attr('data-phone'))
    var total;
    cat_func();
