        ...
        <div class="col-lg-8  p-field">
            <div class="card ">
                ...
                <div class="container card-header text-dark" style="" >
                    ...
                    <input class="form-control form-control-sm" type="text" placeholder="Customer Name" aria-label=".form-control-sm example">
                </div><div class="container card-header text-dark" style="" >
                    <label for="">Customer Phone</label>
                    <input class="form-control form-control-sm" type="number" placeholder="Customer Phone" aria-label=".form-control-sm example">
                </div>
