...
if(!isset($_SESSION['saveCustomer']))
    ...
    //     }
       ...
       if($name != '')
       {
            // $emailCheck = mysqli_query($db_connect, "SELECT * FROM customers WHERE email='$email'");
            // if($emailCheck)
            // {
            //     if(mysqli_num_rows($emailCheck) > 0)
            //     {
...
if(isset($_POST['updateCustomer']))
{
    ...
    //     }
       ...
       if($name != '')
       {
            // $emailCheck = mysqli_query($db_connect, "SELECT * FROM customers WHERE email='$email' AND id!='$customerId'");
            // if($emailCheck)
            // {
            //     if(mysqli_num_rows($emailCheck) > 0)
            //     {
            //         redirect ('edit-customer.php?='.$$customerId,'Email exists');
            //     }
            // }
            ...
            if($result)
            {
                redirect('edit-customer.php?='.$$customerId,'Customer Updated Successfully');
            }
            else
            {
                redirect('edit-customer.php?='.$$customerId,'Something Went Wrong');
            }
       }
       else
       {
            redirect ('edit-customer.php?='.$$customerId,'Fill in the required fields');
       } 
