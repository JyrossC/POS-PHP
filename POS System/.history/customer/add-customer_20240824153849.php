            ...
            <form action="code.php" method="POST">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3 text-end">
                        <br>
                        <button type="submit" name="saveCustomer" class="btn btn-success" style="padding-right: -50px;" >Save</button>
                        <button href="customers.php" class="btn btn-danger float-end">Cancel</button>
                    </div>
                </div>
            </form>
        </div>
