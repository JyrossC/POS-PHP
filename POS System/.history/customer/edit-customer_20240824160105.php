            ...
            <form action="code.php" method="POST">
                <?php
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="number" name="phone" value="<?=$customer['phone'];?>" class="form-control" rows="3"></input>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <br>
                        <input type="checkbox" name="status" value="<?=$customer['status'];?>" style="width: 30px; height: 30px;" />
                    </div>
                    <div class="col-md-6 mb-3 text-between"  >
                        <br>
                        <button type="submit" name="saveCustomer" class="btn btn-success" style="margin-right: 20px;" >Update</button>
