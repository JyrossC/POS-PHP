...
if(isset($_POST['updateCustomer']))
{
    ...
    //     }
       ...
       if($customerId != '')
       {
            ...
            if($result)
            {
                redirect('edit-customers.php?='.$$customerId,'Customer Updated Successfully');
            }
            else
            {
                redirect('edit-customers.php?='.$$customerId,'Something Went Wrong');
            }
       }
       else
       {
            redirect ('edit-customers.php?='.$$customerId,'Fill in the required fields');
       } 
