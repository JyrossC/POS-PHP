...
<body class="bg-dark">
  ...
  <main id="main" >
  		...
  		<div class="container-fluid align-self-center w-100">
		
  		<div id="login-center" class="row justify-content-end" >
  			<div class="card col-md-5 ml-5">
  				<div class="card-body py-5 px-1">
  					<h4 class="text-dark text-center mb-5">
  						<img src="assets/uploads/" width="300px">
  					</h4>
  					<form id="login-form" >
				        ...
				        <input type="password" id="password" name="password" class="form-control border-0" placeholder="Password">
  						...
  						<center><button class="btn col-md-3 btn-success">Login</button></center>
  					</form>
  				</div>
  			</div>
  		</div>
