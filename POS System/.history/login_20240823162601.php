...
<body style="background-color: beige;" >
	...
	<div class="col-6 mt-5" style=" margin-top: -10%;" >
		...
		<div class="col-6">
			<h3 class="text-dark text-center mb-5 mt-5" style="margin-top: -10%; font-family: 'century gothic','Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode',
