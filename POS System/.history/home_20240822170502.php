	...
	<div class="row mt-3 ml-3 mr-3 dashcard">
        ...
        <div class="col-md-3 mb-3">
            <div class="card bg-white border-0 circle-primary theme-circle">
                <div class="card-body">
                    <h5 class="text-primary">No# of Category</h5>
                    <div class="mt-3">
        ...
        <div class="col-md-3 mb-3">
            <div class="card bg-white border-0 circle-secondary theme-circle">
                <div class="card-body">
                    <h5 class="text-warning">No# of Orders</h5>
                    <div class="mt-3">
                        <div class="d-flex align-items-center">
        ...
        <div class="col-md-3 mb-3">
            <div class="card bg-white border-0 circle-success theme-circle">
                <div class="card-body">
                    <h5 class="text-success">No# of Product</h5>
                    <div class="mt-3">
                        <div class="d-flex align-items-center">
        ...
        <div class="col-md-3 mb-3">
            <div class="card bg-white border-0 circle-info theme-circle">
                <div class="card-body">
                    <h5 class="text-info">No# of Users</h5>
                    <div class="mt-3">
                        <div class="d-flex align-items-center">
...
<!-- Embedding Chart Google Analytics Charts -->
