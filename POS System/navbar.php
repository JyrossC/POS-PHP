...
<nav id="sidebar" class='mx-lt-5 bg-white w-10' >
		...
		<h6 class="text-disabled mt-5 text-success" style="margin-left: 50px;" >Shop Insights</h6>
			...
			<a href="index.php?page=orders" class="nav-item nav-orders"><span class='icon-field'><i class="fa fa-clipboard-list mr-3"></i></span>Manage Orders</a>
			...
			<a href="customer/customers.php" class="nav-item nav-customers"><span class='icon-field'><i class="fa fa-clipboard-list mr-3"></i></span>Manage Customers</a>
			<!-- <a href="billing/index.php" class="nav-item nav-takeorders"><span class='icon-field'><i class="fa fa-list-ol mr-3"></i></span> Add Customers</a> -->
			...
			<h6 class="text-disabled  text-success" style="margin-left: 50px;" >Shop Setting</h6>
			...
			<h6 class="text-disabled text-success" style="margin-left: 50px;" >Author Contacts</h6>
				...
				<a href="" target="_blank" class="nav-item nav-visit_website"><span class='icon-field'><i class="fa fa-chat mr-3"></i></span><?php echo $phone ?></a>
		</div>
